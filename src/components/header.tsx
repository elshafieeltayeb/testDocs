...
export const ApplicationHeader: React.FC = (props) => {
    return (
        <header className='relative z-10 w-screen mx-auto'>
...
export const PageHeaderMenuLarge: React.FC = (props) => {
    return (
...
export const PageHeaderNavLarge: React.FC = (props) => {
    return (
...
export const PageHeaderMenuSmall: React.FC = (props) => {
    return (
...
export const PageHeaderNavSmall: React.FC = (props) => {
    return (
